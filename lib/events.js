...
import emitFactory from './event-emitter';
import getClassSelector from './get-class-selector';

const emit = emitFactory(meta.name);

const key = keymap.KEY;
const whitelist = keymap.WHITELIST;
const blacklist = keymap.BLACKLIST;
